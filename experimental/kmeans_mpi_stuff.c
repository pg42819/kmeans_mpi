...
void main_finalize(struct pointset *dataset, struct kmeans_metrics *metrics, struct kmeans_timing *p_timing)
{
...
void finalize(struct kmeans_metrics *metrics, struct kmeans_timing *p_timing)
{
//    MPI_Barrier(MPI_COMM_WORLD);
